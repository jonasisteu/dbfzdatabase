...
INSERT INTO characters (reference, name, season, origin_series, archetype, splash_art_url, thumbnail) VALUES
    ...
    ('adult_gohan', 'Gohan (Adulte)', 'Base', 'Dragon Ball Z', 'Power/Hybrid', 'https://www.dustloop.com/wiki/images/0/08/DBFZ_Adult_Gohan_Portrait.png', 'https://www.dustloop.com/wiki/images/thumb/1/14/DBFZ_Adult_Gohan_Icon.png/130px-DBFZ_Adult_Gohan_Icon.png'),
    ...
    ('gt_goku', 'Goku (GT)', 'Saison 2', 'Dragon Ball GT', 'Hybrid', 'https://www.dustloop.com/wiki/images/5/58/DBFZ_GT_Goku_Portrait.png', 'https://www.dustloop.com/wiki/images/thumb/0/01/DBFZ_GT_Goku_Icon.png/130px-DBFZ_GT_Goku_Icon.png'),
